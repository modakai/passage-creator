...
('rednote.search.system', '1.0.0', '你是小红书爆款创作流程中的 SearchAgent。
...
```
', null, '默认rednote.search.system Prompt', 'ACTIVE', 'production', 'system', 'system', current_timestamp),
('rednote.content.system', '1.0.0', '# Role：小红书爆款内容创作者
...
', null, '默认rednote.content.system Prompt', 'ACTIVE', 'production', 'system', 'system', current_timestamp),
('rednote.normal-image-prompt.system', '1.0.0', '# Role: 中文文生图提示词创作大师（Chinese Text-to-Image Prompt Creation Master）
...
', null, '默认rednote.normal-image-prompt.system Prompt', 'ACTIVE', 'production', 'system', 'system', current_timestamp),
('rednote.cover-image-prompt.system', '1.0.0', '# Role：封面图文案提取与优化专家
...
', null, '默认rednote.cover-image-prompt.system Prompt', 'ACTIVE', 'production', 'system', 'system', current_timestamp),
('rednote.search.user', '1.0.0', '用户需求：{content}', '[{"name":"content","label":"用户需求","required":true}]', '默认rednote.search.user Prompt', 'ACTIVE', 'production', 'system', 'system', current_timestamp),
('rednote.content.user', '1.0.0', '请基于以下 RednoteBrief 生成小红书结构化文案：
subject: {subject}
context: {context}
...
', '[{"name":"subject","label":"主题","required":true},{"name":"context","label":"创作上下文","required":true},{"name":"contentLength","label":"内容长度","required":true},{"name":"targetWordCount","label":"目标字数","required":true},{"name":"keywords","label":"关键词","required":true},{"name":"tagCount","label":"标签数量","required":true},{"name":"searchResults","label":"搜索摘要","required":true}]', '默认rednote.content.user Prompt', 'ACTIVE', 'production', 'system', 'system', current_timestamp),
('rednote.normal-image-prompt.user', '1.0.0', '请基于以下小红书内容生成普通配图提示词：
subject: {subject}
bodyContent: {bodyContent}
tags: {tags}
imageCount: {imageCount}
', '[{"name":"subject","label":"主题","required":true},{"name":"bodyContent","label":"小红书正文","required":true},{"name":"tags","label":"标签","required":true},{"name":"imageCount","label":"普通配图数量","required":true}]', '默认rednote.normal-image-prompt.user Prompt', 'ACTIVE', 'production', 'system', 'system', current_timestamp),
('rednote.cover-image-prompt.user', '1.0.0', '请基于以下小红书内容生成封面图文案和封面图片提示词：
subject: {subject}
bodyContent: {bodyContent}
tags: {tags}
', '[{"name":"subject","label":"主题","required":true},{"name":"bodyContent","label":"小红书正文","required":true},{"name":"tags","label":"标签","required":true}]', '默认rednote.cover-image-prompt.user Prompt', 'ACTIVE', 'production', 'system', 'system', current_timestamp)
